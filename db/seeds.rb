...
ping_pong_game_1 = PingPong.create!(team_1_id: team_a.id, team_2_id: team_b.id, team_1_score: 43, team_2_score: 40)
ping_pong_game_2 = PingPong.create!(team_1_id: team_a.id, team_2_id: team_b.id, team_1_score: 41, team_2_score: 55)
fuzzball_game_1 = FuzzBall.create!(team_1_id: team_a.id, team_2_id: team_b.id, team_1_score: 11, team_2_score: 44)
fuzzball_game_2 = FuzzBall.create!(team_1_id: team_a.id, team_2_id: team_b.id, team_1_score: 9, team_2_score: 33)
