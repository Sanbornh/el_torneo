...
# PingPong.create!(winner: 33)
# PingPong.create!(winner: 35)
# FuzzBall.create!(winner: 34)
# FuzzBall.create!(winner: 36)
# TeamsGame.create!(team_id: 33, game_id: 17, score: 21)
# TeamsGame.create!(team_id: 34, game_id: 17, score: 15)
# TeamsGame.create!(team_id: 35, game_id: 18, score: 21)
# TeamsGame.create!(team_id: 36, game_id: 18, score: 18)
# TeamsGame.create!(team_id: 33, game_id: 19, score: 2)
# TeamsGame.create!(team_id: 34, game_id: 19, score: 8)
# TeamsGame.create!(team_id: 35, game_id: 20, score: 7)
# TeamsGame.create!(team_id: 36, game_id: 20, score: 8)